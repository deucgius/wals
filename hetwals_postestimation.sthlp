...
{p2colset 1 28 30 2}{...}
{p2col:{bf:hetwals postestimation} {hline 2}}Postestimation tools for weighted-average least squares (WALS) estimation of linear models with multiplicative heteroskedasticity{p_end}
{p2colreset}{...}
...
{pstd}
The following postestimation commands are available after {helpb hetwals}:

{synoptset 24 tabbed}{...}
{p2coldent :Command}Description{p_end}
{synoptline}
{synopt :{helpb hetwals_p:predict}}WALS predictions{p_end}
...
{synoptline}
{p 4 6 2}
* {cmd:estimates stats} is not appropriate after {cmd:hetwals} estimation.
